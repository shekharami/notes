...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"postOrGet.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteNote = exports.postOrGet = void 0;

var _axios = _interopRequireDefault(require("axios"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const postOrGet = async (data, type) => {
  //console.log(data)
  let url;
...
var _postOrGet = require("./postOrGet");
...
if (form_get) {
  form_get.addEventListener('submit', async e => {
    ...
    if (!email) {
      ...
      const n = await (0, _postOrGet.postOrGet)({
        email
      }, 'get_data');

      if (n.length === 0) {
        alert('You do not have any Notes saved.'); //location.assign('/');
      } else {
        ...
        let item = `<div id="div_${slno}" class="timestamp">
                            [${new Date(n.data[0].createdAt).toLocaleString(undefined, {
        ...
        for (let i = 1; i < n.length; i++) {
          ...
          item = item + `<div id="div_${slno}" class="timestamp">
                                    [${new Date(n.data[i].createdAt).toLocaleString(undefined, {
            timeZone: 'Asia/Kolkata'
          })}]:👉 
        ...
        for (let i = 0; i < slno; i++) {
          document.getElementById(`delete_${i + 1}`).addEventListener("click", function () {
            ...
            (0, _postOrGet.deleteNote)(n.data[i].id);
            counter -= 1;
...
},{"core-js/modules/web.timers.js":"../../node_modules/core-js/modules/web.timers.js","core-js/modules/web.immediate.js":"../../node_modules/core-js/modules/web.immediate.js","core-js/modules/web.dom.iterable.js":"../../node_modules/core-js/modules/web.dom.iterable.js","./postOrGet":"postOrGet.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
